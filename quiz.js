...
let questions = [
    ...
    answer: "A contaminated object or surface",
    options: [
    ...
    answer: "At least 3 feet (1 meter)",
    options: [
    ...
    {
    numb: 5,
    question: "Can a dog gives you Covid-19?",
    answer: "No",
    options: [
      "Yes",
      "No",
      "Not sure",
      "It depends on human immunity"
